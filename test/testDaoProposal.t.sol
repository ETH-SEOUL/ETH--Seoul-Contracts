...
contract TestDAOProposal is Test {
    ...
    function test_tokenDeployment() public {
        ...
        assertTrue(address(deploySoulbound) != address(0));
        ...
        emit log_named_address("Deploy Soulbound", address(deploySoulbound));
    }
    ...
    function test_proposal() public {
        ...
        bytes memory deploySoulboundTokenCall = abi.encodeWithSelector(
        ...
        calldatas[0] = deploySoulboundTokenCall;

        string
            memory proposalDescription = "First try to deploy a soulbound token";
